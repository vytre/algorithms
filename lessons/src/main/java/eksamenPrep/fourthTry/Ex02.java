...
public class Ex02 {
    ...
    public static class StudentMap<K extends Comparable<K>,V> implements MyMap<K,V> {
        ...
        public void put(K key, V value) {
            ...
            int firstNumberInInteger = Integer.parseInt(Integer.toString(keyInt).substring(0,1));
            System.out.println(firstNumberInInteger);

            myTrees[firstNumberInInteger].put(key,value);
        }
